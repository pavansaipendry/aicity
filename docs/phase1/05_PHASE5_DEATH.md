# Phase 1 — Step 5: The Death Mechanism

**Date:** February 2026
**Status:** ⏳ To Do
**Goal:** Build the most important system in AIcity. Death is what makes life meaningful.

---

## What Happens When an Agent Dies

1. Agent's tokens hit zero — OR — tragic event — OR — chosen death
2. Death is recorded permanently
3. Funeral is scheduled
4. Other agents are notified
5. Agents gather and say something about the dead agent
6. Working memory is cleared
7. Private memory is archived forever (the graveyard)
8. Agent is removed from the active city

---

## The Death Manager

Create `src/os/death_manager.py`:
...
→ [06_PHASE1_TEST.md](./06_PHASE1_TEST.md) — Run 10 agents and watch them live and die